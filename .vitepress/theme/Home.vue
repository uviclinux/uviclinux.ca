...
<template>
  <div class="divide-y divide-gray-200 dark:divide-slate-200/5">
    <div class="pt-6 pb-8 space-y-2 md:space-y-5">
      <h1
        class="text-3xl leading-9 font-bold text-gray-900 dark:text-white tracking-tight sm:text-4xl sm:leading-10 md:text-6xl md:leading-1"
        v-text="frontmatter.title" />
      <p class="text-lg leading-7 text-gray-500 dark:text-white" v-text="frontmatter.subtext" />
    </div>
